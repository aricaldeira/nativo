...
+ existe um teclado numérico “oculto” nas letras, pra ser usado nos notes que não têm teclado numérico, acessado com CapsLock;
...
Use como um modelo pra ajustar o que você achar melhor no seu próprio teclado.
    ...
    ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┲━━━━━━━━━━━┓
    │ | \ │ 7   │ 5   │ 3   │ 1   │ 9   │ 8   │ 0   │ 2   │ 4   │ 6 ⁄ │ % ‰│ R$  ┃Backspace  ┃
    │ { ª │ }   │ ( β │ ) ° │ [ < │ ] > │ = ≠ │ + ± │ - − │ * × │ / ÷ │ # º │ $ ¤ ┃           ┃
    ┢━━━━━┷━┱───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┺━┳━━━━━━━━━┫
    ┃       ┃ ! − │ ; − │ : − │ H ◦ │ X   │ W   │ L « │ T » │ C ‹ │ P › │ ò ᵒ̱ │ & ¶ ┃Enter    ┃
    ┃Tab    ┃ ? − │ , − │ . − │   • │   · │   W̃ │   “ │   ” │   ‘ │   ’ │ õ ố │ " § ┃         ┃
    ┣━━━━━━━┻━┱───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┺━┓       ┃
    ┃Caps     ┃ I   │ E   │ A   │ O   │ U   │ M   │ D   │ S   │ R   │ N   │ ô ᵒ̣ │ @ ø ┃       ┃
    ┃Lock     ┃     │   È │   À │   Ò │   Ŭ │   µ │     │     │     │     │ ó ö │ ' ’ ┃       ┃
    ┣━━━━━┳━━━┹─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┲━━━┻━━━━━━━┫
    ┃Caps ┃ ‐   │ Y   │ Ç   │ J   │ B   │ K   │ Q   │ V   │ G   │ F   │ Z   │ |   ┃Caps       ┃
    ┃Shift┃ ’   │   Ỹ │     │     │     │     │     │     │     │     │     │ \   ┃Shift      ┃
    ┣━━━━━┻┳━━━━┷━┳━━━┷━━━┱─┴─────┴─────┴─────┴─────┴─────┴─────┴─┲━━━┷━━┳━━┷━━━┳━┻━━━━┳━━━━━━┫
...
### Teclado numérico
    ...
    ┃Lock ┃ / ∕ │ * 0̅ │ - ⁻ │   /       ÷                     ∕ (forma frações U+2044)
    ┡━━━━━╃─────┼─────┼─────┤   *       ×                     0̅ (dízima)        ⋅ (multiplicação "ponto")
    │ ⁷   │ ⁸   │ ⁹   │ + ₊ │   -       − (negativo)          ⁻ (superscrito)   ₋ (subscrito)
    │ 7 ₇ │ 8 ₈ │ 9 ₉ │ + ⁺ │   +                             ⁺ (superscrito)   ₊ (subscrito)
    ├─────┼─────┼─────┼─────┤   ,       espaço fio (U+200A)   espaço inseparável fino (U+202F)
    │ ⁴   │ ⁵   │ ⁶   │ ˙   │   .       ponto acima (U+02D9)
    │ 4 ₄ │ 5 ₅ │ 6 ₆ │ .   │
    ├─────┼─────┼─────╆━━━━━┪   Para os números, o normal é o número, Shift dá o número como potência,
    │ ¹   │ ²   │ ³   ┃  E  ┃      AltGr dá o número como índice, AltGr + Shift dá a seta simples:
    │ 1 ₁ │ 2 ₂ │ 3 ₃ ┃  N  ┃   ↖↑↗
    ├─────┴─────┼─────┨  T  ┃   ←↔→
    │ ⁰         │     ┃  E  ┃   ↙↓↘
    │ 0       ₀ │   , ┃  R  ┃   ↕
...
### Teclado numérico “embutido”
    ...
    ┣━━━━━┳━━━┹─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┲━━━┻━━━━━━━┫
    ┃Caps ┃     │     │     │     │     │     │     │ ˙   │     │     │     │     ┃Caps       ┃
    ┃Shift┃     │     │     │     │     │     │ ,   │ .   │ 00  │ 000 │ 0000│ ZWJ ┃Shift      ┃
    ┣━━━━━┻┳━━━━┷━┳━━━┷━━━┱─┴─────┴─────┴─────┴─────┴─────┴─────┴─┲━━━┷━━┳━━┷━━━┳━┻━━━━┳━━━━━━┫
    ┃      ┃      ┃       ┃                                       ┃      ┃      ┃      ┃      ┃
    ┃Ctrl  ┃Meta  ┃Alt    ┃ Espaço    ␣                           ┃AltGr ┃Meta  ┃Menu  ┃Ctrl  ┃
    ┗━━━━━━┻━━━━━━┻━━━━━━━┹───────────────────────────────────────┺━━━━━━┻━━━━━━┻━━━━━━┻━━━━━━┛
---
...
Testado usando xkeyboard-config versão 2.37 no Arch Linux.
    ...
    │ { ᵃ̱ │ }   │ ( β │ ) ° │ [ < │ ] > │ = ≠ │ + ± │ - − │ * × │ / ÷ │ # ᵘ̱ │ $ ¤ ┃           ┃
    ┢━━━━━┷━┱───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┺━┳━━━━━━━━━┫
    ┃       ┃ ! − │ ; − │ : − │ W ◦ │ Y   │ ô ò │ T « │ K » │ P ‹ │ L › │ H   │ & ¶ ┃Enter    ┃
    ┃Tab    ┃ ? − │ , − │ . − │   • │   · │ ó õ │   “ │   ” │   ‘ │   ’ │     │ " § ┃         ┃
    ┣━━━━━━━┻━┱───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┺━┓       ┃
    ┃Caps     ┃ E   │ U   │ A   │ I   │ O   │ D   │ S   │ N   │ R   │ M   │ C   │ @ ø ┃       ┃
    ┃Lock     ┃     │   Ŭ │   À │     │     │     │     │     │     │     │   Ç │ ' ’ ┃       ┃
    ┣━━━━━┳━━━┹─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┲━━━┻━━━━━━━┫
    ┃Caps ┃ ‐   │ X   │ J   │ Ò   │ È   │ Ỹ   │ Z   │ V   │ F   │ B   │ G   │ Q   ┃Caps       ┃
    ┃Shift┃ ’   │     │     │     │     │     │     │     │     │     │     │     ┃Shift      ┃
    ┣━━━━━┻┳━━━━┷━┳━━━┷━━━┱─┴─────┴─────┴─────┴─────┴─────┴─────┴─┲━━━┷━━┳━━┷━━━┳━┻━━━━┳━━━━━━┫
    ┃      ┃      ┃       ┃ Underline _   Espaço inseparável fino ┃      ┃      ┃      ┃      ┃
    ┃Ctrl  ┃Meta  ┃Alt    ┃ Espaço    ␣        Espaço inseparável ┃AltGr ┃Meta  ┃Menu  ┃Ctrl  ┃
